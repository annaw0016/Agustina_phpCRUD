...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $email = $_POST['email'];
    $alamat_lngkp = $_POST['alamat_lngkp'];
    ...
    $sql_update = "UPDATE tb_users SET nama=?, alamat=?, nohp=?, jenis_kelamin=?, email=?, alamat_lngkp=?, foto=? WHERE id=?";

    // Siapkan statement untuk menghindari SQL Injection
    $stmt = $conn->prepare($sql_update);
    $stmt->bind_param('sssssssi', $nama, $alamat, $nohp, $jenis_kelamin, $email, $alamat_lngkp, $fotoBaru, $id);
...
<body>
    <div class="container mt-4">
        ...
        <form method="POST" enctype="multipart/form-data"> <!-- Tambahkan enctype untuk mengunggah file -->
            ...
            <div class="mb-3">
                <label for="alamat_lngkp" class="form-label">Alamat Lengkap</label>
                <input type="text" class="form-control" id="alamat_lngkp" name="alamat_lngkp" value="<?php echo $row['alamat_lngkp']; ?>">
            </div>
            <div class="mb-3">
