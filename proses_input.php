...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (!empty($_POST['nama']) && !empty($_POST['alamat']) && !empty($_POST['nohp']) && !empty($_POST['email']) && !empty($_POST['jenis_kelamin']) && && !empty($_POST['alamat_lngkp']) && !empty($_FILES['foto']['tmp_name'])) {
            ...
            $alamat_lngkp = htmlspecialchars($_POST['alamat_lngkp']);
            ...
            $stmt->bindParam(':alamat_lngkp', $alamat_lngkp);
